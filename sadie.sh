...
echo "3. While still holding Reset, press and hold the Recovery Button."
echo "4. Release the Reset Button, but keep holding Recovery for at least three seconds."
echo ""
